...
public class ApiRequesterImpl extends BaseApiRequester implements ApiRequester {

    public ApiRequesterImpl(String fnsApiBaseUrl, IUserCredentialsProvider userCredentialsProvider) {
